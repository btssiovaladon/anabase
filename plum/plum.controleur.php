...
Class Plum_controleur{
	...
	private $vue=null;		//String dernière vue useVue
	
	private $v=null;	//Plum_vue
	
	private $paramUrl=null;	//Plum_data
	
	private $persist=null;	//Plum_sacoche : "persist"
	...
	protected function __construct($param){ 
		...
		$this->persist=new PlumSacoche($this->pathControleur()."persisto....ob_cleany98765fhhd");//isolation de persist
	...
	public function __get($name){
		switch($name){
			...
			case "persist":return $this->persist;
...
class Plum_vue{
		...
		private $redirect;	//String URI de redirection sur affichage formulaire
	...
	public function redirect($controleur,$action){
		$this->redirect=$this->c->forgeUri($this->package,$controleur,$action);
	}
